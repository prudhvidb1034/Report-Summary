...
export class ProjectStatusComponent extends ComponentStore<State> implements AfterViewInit, OnDestroy, OnInit {
  ...
  private sampleProjects: Project[] = [
    { id: 1, name: 'CUSTOMER 365' },
    { id: 2, name: 'ON BOARDING' },
    { id: 3, name: 'INITIO' },
    { id: 4, name: 'SERVICE NOW' },
    { id: 5, name: 'RPA' },
    { id: 6, name: 'UX' },
  ...
  private sampleStatusData: { [projectId: number]: ProjectStatus } = {
    1: {
      projectId: 1,
      projectName: 'CUSTOMER 365',
      status: 'Completed',
      summary:['updated  UI Screens','API Integration is completed'],
