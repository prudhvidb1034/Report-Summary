...
import { Person, RegistrationForm } from '../../models/register.mode';
...
public validationService = inject(ValidationsService)
  ...
  ngOnInit() {
    ...
    if (this.editData) {
      ...
      console.log('TechStack in editData:', this.editData.techStack[0],this.editData);
